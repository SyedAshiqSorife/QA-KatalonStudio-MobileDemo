...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - (2)'), 'ashiq31@gmail.com', 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - (3)'), 'asdfgh', 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.FrameLayout'), 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.TextView - (3)'), 0)

Mobile.checkElement(findTestObject('Login/android.widget.TextView - (3)'), 0)
